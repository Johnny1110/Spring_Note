...
import com.frizo.demo.polling.dao.PollRepository;
import com.frizo.demo.polling.dao.UserRepository;
import com.frizo.demo.polling.dao.VoteRepository;
import com.frizo.demo.polling.entity.*;
import com.frizo.demo.polling.exception.BadRequestException;
...
import com.frizo.demo.polling.utils.ModelMapper;
...
public class PollServiceImpl implements PollService {
    ...
    @Override
    public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int from, int to) {
        validatePageNumberAndSize(from , to);

        Pageable pageable = PageRequest.of(from, to, Sort.Direction.DESC, "createdAt");
    ...
    @Override
    public PagedResponse<PollResponse> getPollsCreatedBy(String username, UserPrincipal currentUser, int from, int to) {
        validatePageNumberAndSize(from, to);
